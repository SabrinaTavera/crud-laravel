                ...
                <li class="sidebar-item"> 
                    ...
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        <li class="sidebar-item"><a href="{{ route('product.index') }}" class="sidebar-link">
                            <span class="hide-menu"> Produtos Ativos </span></a>
                        </li>
                        <li class="sidebar-item"><a href="{{ route('inactive') }}" class="sidebar-link">
                            <span class="hide-menu">Produtos Inativos</span></a></li>
